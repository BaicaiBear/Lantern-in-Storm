...
public class WarpBeginningLanternRenderer extends EntityRenderer<BeginningLanternEntity> {
    protected static final Identifier TEXTURE = Identifier.of(MOD_ID, "textures/entity/warp_lantern_ring.png");
    ...
    public WarpBeginningLanternRenderer(EntityRendererFactory.Context context) {
        super(context);
