...
public class LSTeam {
    ...
    public void disbandTeam() {
        ...
        for (ServerPlayerEntity member : new HashSet<>(members)) { // 使用副本遍历以避免修改集合时的并发修改异常
            if (member instanceof LSPlayerAccessor cePlayerAccessor) {
