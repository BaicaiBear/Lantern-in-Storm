        ...
        if (renderer != null) {
            ...
            for (Map.Entry<String, Obj> entry : materialGroups.entrySet()) {
                ...
                for (int i = 0; i < matGroupObj.getNumFaces(); i++) {
                    ...
                    try {
                        emitter.colorIndex(MtlReader.read(new InputStreamReader((new FileInputStream("/Users/baicaibear/Documents/小程序们/Lantern-in-Storm/src/main/resources/assets/minecraft/block/mtl/boundary.mtl")))).getFirst().getTintIndex());
                    } catch (IOException e) {
